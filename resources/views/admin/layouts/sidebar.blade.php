        ...
        <div class="sidebar-menu p-3 flex-grow-1 overflow-y-auto">
            <script>
                ...
                navItems.innerHTML += `
                    <li class="nav-item">
                        <h2>{$userRole}</h2>
                        <a href="/transactions" class="nav-link d-flex align-items-center py-2 px-3">
                            <i class="bi bi-credit-card me-2"></i>
                            <span>Transactions</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/customers" class="nav-link d-flex align-items-center py-2 px-3">
                ...
                if (userRole === 'admin') {
                    navItems.innerHTML += `
                        <li class="nav-item">
                            <a href="/stats" class="nav-link d-flex align-items-center py-2 px-3">
                                <i class="bi bi-grid-1x2-fill me-2"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/users" class="nav-link d-flex align-items-center py-2 px-3">
                                <i class="bi bi-person-gear me-2"></i>
                                <span>Utilisateurs</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/settings" class="nav-link d-flex align-items-center py-2 px-3">
                ...
                // Manager-specific items
                    ...
                    navItems.innerHTML += `
                        <li class="nav-item">
                            <a href="/manager-stats" class="nav-link d-flex align-items-center py-2 px-3">
                                <i class="bi bi-briefcase-fill me-2"></i>
                                <span>Manager Dashboard</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/reports" class="nav-link d-flex align-items-center py-2 px-3">
